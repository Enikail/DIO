...
class __TwigTemplate_f87f46d9265f930b038a079ae0b90be7 extends Template
{
    private $source;
    private $macros = [];
...
{{ form_start(form) }}
    ...
    <button type=\"submit\">Ajouter</button>
{{ form_end(form) }}
{% endblock %}", "category/create.html.twig", "/home/mohamed/Downloads/project/templates/category/create.html.twig");
    }
}
