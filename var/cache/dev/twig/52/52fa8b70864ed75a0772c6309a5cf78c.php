...
class __TwigTemplate_aadb8a5a451ec868fcd0c9af08199c54 extends Template
{
    private $source;
    private $macros = [];
...
{{ form_start(form) }}
    ...
    <button type=\"submit\">Ajouter</button>
{{ form_end(form) }}
{% endblock %}", "category/create.html.twig", "/home/mohamed/Downloads/project_siaci/templates/category/create.html.twig");
    }
}
